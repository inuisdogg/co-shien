-- ログインしているユーザー（66937dee-0b4f-4d2b-b075-63656b21a94a）をテストデータと紐付け
...
BEGIN
  -- ユーザーを取得
  SELECT id INTO v_user_id FROM users WHERE id = '66937dee-0b4f-4d2b-b075-63656b21a94a';
  
  IF v_user_id IS NULL THEN
    RAISE NOTICE 'ユーザー 66937dee-0b4f-4d2b-b075-63656b21a94a が見つかりません';
    RETURN;
  END IF;
