              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-gray-700">
                    経験年数
                    <span className="ml-2 inline-flex min-w-[3rem] items-center justify-center rounded-full bg-indigo-50 px-2.5 py-0.5 text-sm font-bold text-personal-dark">
                  ...
                  <input
                    ...
                    className="w-full h-2 rounded-full appearance-none bg-gray-200 accent-personal cursor-pointer"
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm transition-colors focus:border-personal focus:outline-none focus:ring-2 focus:ring-personal/20"
                  >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="lg:sticky lg:top-20 space-y-6">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                {/* Total */}
                <div className="rounded-xl bg-gradient-to-r from-personal to-personal-dark p-5 text-white">
                  <div className="flex items-baseline justify-between">
