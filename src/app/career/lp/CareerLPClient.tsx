/**
 * キャリアアカウント LP - Client Component
 * 個人の専門職向けのランディングページ
 *
 * ターゲット: 障害福祉の専門職（保育士、児発管、PT/OT/ST等）
 * 主要訴求: 資格・経歴のデジタルウォレット、キャリアデータのポータビリティ
 * CTA先: /career/signup
 */
...
export default function CareerLPClient() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-20 pb-16 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6 tracking-tight">
          資格・経歴を、<br className="hidden sm:block" />
          スマホでずっと管理。
        </h1>
        <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
          実務経験証明書、資格証、履歴書。あちこちに散らばるキャリア情報を、<br className="hidden md:block" />
          ひとつのアカウントで安全に保管。
        </p>
