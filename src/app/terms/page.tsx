      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose prose-sm max-w-none space-y-6">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第2条（利用登録）</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第3条（ユーザーIDおよびパスワードの管理）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第4条（利用料金および支払方法）</h2>
              <p className="text-gray-700 leading-relaxed">
                本サービスの利用料金、支払方法、支払時期については、別途当社が定める利用契約に従うものとします。
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第5条（禁止事項）</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第6条（本サービスの提供の停止等）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第7条（保証の否認および免責）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第8条（サービス内容の変更等）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第9条（利用規約の変更）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                ...
                <li>当社はユーザーに対し、前項による本規約の変更にあたり、事前に、本規約を変更する旨および変更後の本規約の内容並びにその効力発生時期を通知いたします。</li>
              </ol>
            </section>

            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第10条（個人情報の取扱い）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第11条（通知または連絡）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第12条（権利義務の譲渡の禁止）</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">第13条（準拠法・裁判管轄）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
