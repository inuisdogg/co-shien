      ...
      <main className="max-w-6xl mx-auto px-4 py-6 print:p-0">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 print:shadow-none print:border-0 print:p-0">
          ...
          <div className="mt-6 grid grid-cols-4 gap-4 print:mt-4">
            ...
            <div className="bg-orange-50 rounded-lg p-3 text-center print:bg-white print:border print:border-gray-400">
              <p className="text-2xl font-bold text-orange-600 print:text-lg">
          ...
          <div className="bg-white rounded-lg shadow-2xl max-w-md w-full p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-orange-400 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded-md"
              >
                保存
              </button>
            </div>
