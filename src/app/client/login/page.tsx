      ...
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-md p-8">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          ...
          <button
            ...
            className="w-full bg-orange-400 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded-md transition-colors text-sm"
          >
            保護者として新規登録
          </button>
        </div>
