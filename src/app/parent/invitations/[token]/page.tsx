            ...
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all ${
                index < currentStep
                  ...
                  : index === currentStep
                  ? 'bg-client text-white ring-4 ring-client/20'
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-50 p-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 max-w-md w-full p-8 text-center">
          ...
          <button
            ...
            className="text-sm text-client hover:text-client-dark font-medium flex items-center gap-1 mx-auto"
          >
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-center gap-3">
            <Building2 size={16} className="text-client shrink-0" />
            <div>
          ...
          {(child || invitation.temp_child_name) && (
            <div className="flex items-center gap-3">
              <Heart size={16} className="text-client shrink-0" />
              <div>
          ...
          <div className="flex items-center gap-3">
            <Shield size={16} className="text-client shrink-0" />
            <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 max-w-md w-full p-8">
        ...
        <div className="text-center mb-6">
          <Image
            ...
            priority
          />
          <div className="w-16 h-16 bg-client/10 rounded-full flex items-center justify-center mx-auto mb-4">
            <Building2 size={28} className="text-client" />
          </div>
          <p className="text-sm text-client font-medium mb-1">
            保護者の方へ
          </p>
        ...
        {invitationStatus === 'expired' && (
          <div className="text-center">
            ...
            <button
              onClick={() => router.push('/parent')}
              className="text-sm text-client hover:text-client-dark font-medium"
            >
              ダッシュボードへ戻る
            </button>
          </div>
        ...
        {invitationStatus === 'accepted' && (
          <div className="text-center">
            <button
              onClick={() => router.push('/parent')}
              className="w-full bg-client hover:bg-client-dark text-white font-bold py-3 px-4 rounded-xl transition-colors flex items-center justify-center gap-2"
            >
        ...
        {invitationStatus === 'pending' && !isLoggedIn && invitation && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-client hover:bg-client-dark text-white font-bold py-3.5 px-4 rounded-xl transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-lg text-base"
            >
              <LogIn size={18} />
              ログインして承認
            </button>
            <button
              ...
              className="w-full bg-white border-2 border-client text-client hover:bg-amber-50 font-bold py-3 px-4 rounded-xl transition-colors flex items-center justify-center gap-2 text-base"
            >
              <UserPlus size={18} />
              新規登録して承認
            </button>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={processing}
                className="w-full bg-client hover:bg-client-dark text-white font-bold py-3.5 px-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-md hover:shadow-lg text-base"
              >
                {processing ? (
                  <>
