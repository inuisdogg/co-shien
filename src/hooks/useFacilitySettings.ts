      ...
      try {
        ...
        if (data) {
          setFacilitySettings({
            ...
            homepageCoverImageUrl: data.homepage_cover_image_url || '',
            homepagePhotos: data.homepage_photos || [],
            homepageTheme: data.homepage_theme || 'teal',
  ...
  const updateFacilitySettings = async (settings: Partial<FacilitySettings>, changeDescription?: string) => {
    ...
    try {
      ...
      const upsertData: any = {
        ...
        homepage_cover_image_url: updatedSettings.homepageCoverImageUrl || null,
        homepage_photos: updatedSettings.homepagePhotos || [],
        homepage_theme: updatedSettings.homepageTheme || 'teal',
